...
// IT IS HOW OUT DATA WILL GET FILLED IN EDIT RESUME SO ITS ONLY INPUT TYPE. HERE I WILL GET HOW TO FILL AS WELL AS 
// IT WILL BE LIKE DATA WILL BE PASSED HERE 
