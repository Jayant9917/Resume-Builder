...
const CreateResumeForm = () => {
    ...
    return (
        <div className='w-full max-w-md p-8 bg-white rounded-2xl border border-gray-100 shadow-lg'>
            <h3 className='text-2xl font-bold taxt-gray-900 mb-2'>Create New Resume</h3>
            <p className='text-gray-600 mb--8'>
                Give your resume a title to get started. You can customize everything later.
            </p>

            <form onSubmit={handleCreateResume}>
                <Input value={title} onChange={({ target }) => setTitle(target.value)} label='Resume Title'
                placeholder='e.g., Jay Rana - Web Developer' type='text'/>
