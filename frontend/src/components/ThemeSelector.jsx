        ...
        <div className='max-w-7xl mx-auto px-4'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8 '>
                <div className='lg:col-span-2 bg-white rounded-2xl border border-gray-100 p-4 sm:p-6'>
                    <div className='gird gird-cols-1 sm:grid-cols-2 gap-4 max-h-[60vh] lg:max-h-[70vh]
                    overflow-auto p-2'>
                ...
                {/* RIGHT AREA */}
                <div className='lg:col-span-3 bg-white rounded-2xl border border-gray-200 p-4 sm:p-6' ref={resumeRef}>
